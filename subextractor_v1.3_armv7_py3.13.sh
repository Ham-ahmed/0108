...
echo -e "${CYAN}"
echo "####################################################################"
echo "# Start downloading and installing  subextractor_v1.3_armv7_py3.13 #"
echo "####################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/0108/refs/heads/main/enigma2-plugin-extensions-subextractor_v1.3-r1_armv7_py3.13_all.ipk"
IPK_NAME="enigma2-plugin-extensions-subextractor_v1.3-r1_armv7_py3.13_all.ipk"
