...
echo -e "${CYAN}"
echo "########################################################################"
echo "# Start downloading and installing subextractorlite_v1.0-armv7l_py3.14 #"
echo "########################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/0108/refs/heads/main/enigma2-plugin-extensions-subextractorlite_v1.0-armv7l_py3.14_all.ipk"
IPK_NAME="enigma2-plugin-extensions-subextractorlite_v1.0-armv7l_py3.14_all.ipk"
