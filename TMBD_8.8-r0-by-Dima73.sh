...
echo -e "${CYAN}"
echo "###############################################################"
echo "#    Start downloading and installing TMBD_8.8-r0-by-Dima73   #"
echo "###############################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/0108/refs/heads/main/TMBD_8.8-r0-by-Dima73-Mod-RAED_Py3.ipk"
IPK_NAME="TMBD_8.8-r0-by-Dima73-Mod-RAED_Py3.ipk"
