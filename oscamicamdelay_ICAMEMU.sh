...
echo -e "${CYAN}"
echo "################################################################"
echo "# Start downloading and installing oscamicamdelay_ICAMEMU      #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/0108/refs/heads/main/enigma2-plugin-softcams-oscamicamdelay_ICAMEMU-Kitte888-V1Rev_all.ipk"
IPK_NAME="enigma2-plugin-softcams-oscamicamdelay_ICAMEMU-Kitte888-V1Rev_all.ipk"
